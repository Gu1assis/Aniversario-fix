...
Reconhecido pelo riso frouxo, pelo azar em todos os jogos, por falar várias merdas e por amar demais a Beatriz, Michel vive o sonho de tomar os meios de produção enquanto canta para cachorros. Santista amaldiçoado por escolha (e pela ausência de amor-próprio), também é lembrado por uma característica peculiar: depois de uma dose de Canelinha, existe uma chance estatisticamente alta de começar a abraçar os amigos e chorar por algum motivo misterioso.`,
    ...
    rachid: {
        ...
        instagram: "po_rachid",
        desc: `Não sei muito o que falar sobre mim... Eu sou o Rachid, e acho que essa indecisão (até para pensar no que vou escrever aqui) é minha maior característica, junto com toda a aleatoriedade que me persegue, um pouco de agitação e o dom de ser atrapalhado. Já comecei uns 7 cursos diferentes (na verdade foram mais, mas enfim, não vem ao caso) e finalmente estou quase terminando um: ADS (glória)!!!! Amo fazer de tudo um pouco. No momento, como já falei, estou terminando a faculdade e também faço teatro e estágio. A coisa mais legal do mundo para mim é sair com os amigos no fim de semana e tomar uma cervejinha <strong>(pena que, para a maioria, isso já não é mais prioridade, nem eu 🥲)</strong>, preferencialmente no Bortoleto (melhor bar e melhores porções de almôndega de Itape e região). E, sinceramente, sei lá... não gosto muito de falar sobre mim. Sou bem melhor ao vivo, eu acho.
